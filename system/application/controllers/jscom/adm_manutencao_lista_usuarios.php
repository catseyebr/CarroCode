<?php
class Adm_Manutencao_Lista_Usuarios extends MyController {
	
	public $get_vars;
	
 	function Adm_Manutencao_Lista_Usuarios () {
  	...
  	public function index () {
		...
		$usuarios_count = $this->get('usuario_model', NULL);
		$count = count($usuarios_count);
		if($count > 0){
		...
		if($search == TRUE){
			$usuarios = $this->get('usuario_model', array(
					'sortBy' => $sidx,
					'sortDirection' => $sord,
					'limit' => $limit,
					'offset' => $start,
		...
		foreach($usuarios as $usu){
			echo "<row id='". $usu->usu_id."'>"; 
			echo "<cell>". $usu->usu_id."</cell>"; 
			echo "<cell><![CDATA[". $usu->usu_login."]]></cell>"; 
			echo "<cell>". $usu->usu_cpf_id."</cell>"; 
			echo "<cell><![CDATA[". $usu->usu_senha."]]></cell>"; 
			echo "<cell><![CDATA[". $usu->usu_ativo."]]></cell>"; 
			echo "<cell><![CDATA[". $usu->usu_dthcadastro."]]></cell>"; 
			echo "</row>"; 
		} 
		echo "</rows>";
	}
