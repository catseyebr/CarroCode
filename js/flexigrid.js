...
(function($){
	...
	$.addFlex = function(t,p)
	{
		...
		p = $.extend({
			 ...
			 title: false,
			 pagestat: 'Total: {total} ítens'/*'Exibindo de {from} até {to}. Total: {total} itens'*/,
			 procmsg: 'Processando, por favor aguarde ...',
			 query: '',
			 qtype: '',
			 nomsg: 'Sem ítens para exibir',
		...
		if (p.searchitems)
			{
				...
				$(g.sDiv).append("<div class='sDiv2'>Busca rápida <input type='text' size='30' name='q' class='qsbox' /> <select name='qtype'>"+sopt+"</select> <input type='button' value='Limpar' /></div>");
