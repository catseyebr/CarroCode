function Busca () {
  ...
  this.sort = function  (elm) {
    ...
    for (j = 0; j < this.catM[catI].loc.length; j++) {
      html_logos += '<li><img src="/images/locadoras/locadora_' + this.catM[catI].loc[j] + '.jpg"></li>';
    }
    
    html += '<div class="topo_locadoras2 cima"><div class="show_categorias cima"><img alt="Categorias" src="/images/carroaluguel/seta_cima.jpg"></div><div class="show_categorias cima"><img alt="Categorias" src="/images/carroaluguel/seta_cima.jpg"></div><div class="numeracao_comparacao2">' + html_numeracao + '</div><div class="marca_cima2"><ul>' + html_logos + '</ul></div></div>';
