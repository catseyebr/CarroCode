function Busca () {
  ...
  this.sliderBuscaLoad = function () {
    ...
    $('.lk_exibir').click(function(){
      ...
      $('.marca_cima2').css('left', -(pbusca.point * 109));
      $('.numeracao_comparacao2').css('left', -(pbusca.point * 109));
      $('.sub_container_precos2').css('left', -(pbusca.point * 109));
